...
import { ArrowLeft, Save, Tag, Globe, Clock, FileText } from "lucide-react";
...
export default function NewBlog() {
  ...
  const [formData, setFormData] = useState({
    ...
    link: "",
    description: "",
    content: "", // Nội dung chi tiết blog
    tags: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const blogData: Omit<BlogData, 'CREATED_AT' | 'UPDATED_AT'> = {
        ...
        CONTENT: formData.content, // Thêm nội dung chi tiết
      ...
      logActivity.blogCreated(formData.title);
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Thêm bài blog mới vào portfolio của bạn
          </p>
        </div>
      </div>
