      ...
      <section className="py-16">
        ...
        <div className="max-w-4xl text-muted-foreground text-sm text-justify leading-relaxed">
          <p className="mt-2 mb-4">
            Tôi là Hoàng Cao Thống, 16 tuổi, đầy tham vọng trong việc xây dựng 
            thương hiệu cá nhân qua lập trình. Chuyên về phát triển Discord Bot, 
            website bán hàng và các tools hỗ trợ kinh doanh. Mục tiêu của tôi là 
            trở thành entrepreneur công nghệ và đạt được tự do tài chính từ sớm.
          </p>
        </div>
      </section>
